...
- Avoid the broader family of essay-register filler that praises something without saying what is true about it. Specific patterns to drop: "X earns its keep" (say what X buys you), "the real payoff" (say what the payoff is), "X shines when..." (say what makes X well-suited - usually "X is well-suited when..." or describe the concrete property), "the headline benefit / feature" (just describe the benefit), "X reads cleanly / fluently" (covered by the clean rule above; name the concrete property), "X is the connective tissue" or other body-part metaphors ("the bones are the same", "the heart of"), "papercuts" as a stand-in for "small repetitive annoyances" (name the annoyance), "what makes X pleasant" or "X is pleasant / nice / neat / elegant" (say what concrete property X has - exhaustiveness, locality, low ceremony, single declaration site - that earns the praise), "the right call" as approval of a design choice (name the actual reason it's right - what would have broken otherwise), "X is honest" / "an honest limitation" (drop the qualifier; if X is a real limitation, just say so and describe what it is), "the pragmatic rule" or "pragmatic" as a qualifier on a rule or choice (drop it; the rule stands or doesn't on its merits, and "pragmatic" reads as self-congratulation), "free win", "earns its place", "punches above its weight", "out of the gate", "comes into its own", "gets out of the way", "just works". Rule of thumb: if you cannot replace the phrase with a sentence that names the specific property, mechanism, or operation, the phrase is doing decoration and not communication. Cut it or rewrite it.
- Cut hollow intensifiers and hedges. Words like "actually", "really", "very", "quite", "truly", "basically", "literally", "essentially", "simply" usually do not add information; the sentence reads the same with them gone. "the handlers actually differ" is just "the handlers differ". "very large numbers" is just "large numbers". "the rule that holds up" is exactly as strong as "the pragmatic rule that holds up". "wide type families" is exactly as informative as "very wide type families". Keep these words only when they carry real contrast: "the real `enum`" when distinguishing from a metaphorical one, "just `Object`" when emphasizing "only", "actually meant" when contrasting intent with appearance. Test: delete the word and read the sentence aloud. If nothing is lost, it was filler. Same goes for hedges like "perhaps", "maybe", "sort of", "kind of", "in some sense" - if the claim is true, state it; if it is not, do not write it.
